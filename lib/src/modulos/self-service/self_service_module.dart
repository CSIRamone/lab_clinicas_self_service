...
import 'package:fe_lab_clinicas_self_service/src/modulos/self-service/documents/scan_confirm/documents_scan_confirm_router.dart';
...
import 'package:fe_lab_clinicas_self_service/src/repositories/infomation_form/information_form_repository.dart';
import 'package:fe_lab_clinicas_self_service/src/repositories/infomation_form/information_form_repository_impl.dart';
...
class SelfServiceModule extends FlutterGetItModule {
  ...
  Map<String, WidgetBuilder> get pages => {
    ...
    '/documents_scan_confirm': (context) => const DocumentsScanConfirmRouter(),
